...
import { getChatService, Message } from "@/chatbot/chat-service"
...
export function Chatbot({ onClose }: ChatbotProps) {
  ...
  return (
    <Card className="w-full max-w-96 h-[60vh] sm:h-[500px] bg-gray-900 border-gray-800 shadow-2xl">
      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3 bg-gradient-to-r from-purple-600 to-blue-600">
        ...
        <div className="flex space-x-1">
          ...
          <Dialog>
            ...
            <DialogContent className="w-full sm:max-w-md bg-gray-900 text-white border-gray-800">
              <DialogHeader>
