...
import { Eye, EyeOff, LogIn, ArrowLeft, Mail, Lock, AlertCircle, GraduationCap } from "lucide-react"
...
export default function StudentLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-blue-900/30 to-black flex items-center justify-center p-6">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">Sign in to join hackathons and find teammates</p>
        </div>
