...
const mockParticipants = [
  { id: '1', name: 'You', avatar: 'YU', isMuted: false, isVideoOn: true, isHost: true },
  { id: '2', name: 'Dev Dharrshan', avatar: 'DH', isMuted: false, isVideoOn: true, isHost: false },
  { id: '3', name: 'Divyadharshini', avatar: 'DD', isMuted: false, isVideoOn: true, isHost: false },
  { id: '4', name: 'Divakar', avatar: 'DV', isMuted: true, isVideoOn: true, isHost: false },
  { id: '5', name: 'Anusree', avatar: 'AN', isMuted: false, isVideoOn: true, isHost: false },
  { id: '6', name: 'Hemapriya', avatar: 'HP', isMuted: false, isVideoOn: true, isHost: false },
  { id: '7', name: 'Bharani', avatar: 'BH', isMuted: true, isVideoOn: false, isHost: false }
]

// Mock chat messages
const mockMessages = [
  { id: '1', sender: 'Dev Dharrshan', message: 'Hey everyone! Ready for the demo? 🚀', time: '10:25 AM', avatar: 'DH' },
  { id: '2', sender: 'Divyadharshini', message: 'Excited to see the new features!', time: '10:27 AM', avatar: 'DD' },
  { id: '3', sender: 'Divakar', message: 'The UI looks amazing! Great work team 👍', time: '10:29 AM', avatar: 'DV' },
  { id: '4', sender: 'Anusree', message: 'Great presentation! The testing looks solid 👏', time: '10:30 AM', avatar: 'AN' },
  { id: '5', sender: 'Hemapriya', message: 'Can you share the project timeline slides?', time: '10:32 AM', avatar: 'HP' },
  { id: '6', sender: 'Dev Dharrshan', message: 'I have some suggestions for the next sprint', time: '10:34 AM', avatar: 'DH' },
  { id: '7', sender: 'Divyadharshini', message: 'The performance improvements are impressive! 📈', time: '10:36 AM', avatar: 'DD' },
  { id: '8', sender: 'Bharani', message: 'The deployment pipeline looks good to go 🚀', time: '10:37 AM', avatar: 'BH' },
  { id: '9', sender: 'Divakar', message: 'Should we schedule a follow-up meeting?', time: '10:38 AM', avatar: 'DV' },
  { id: '10', sender: 'Anusree', message: 'I can prepare the QA report for next week', time: '10:40 AM', avatar: 'AN' }
]
...
export default function HackMeetPage() {
  ...
  // Generate meeting ID on client side only
  useEffect(() => {
    setMeetingId("MEET-" + Math.random().toString(36).substring(2, 8).toUpperCase())
  }, [])
  ...
  const leaveMeeting = () => {
    if (confirm('Are you sure you want to leave the meeting?')) {
      // Try to close the window, fallback to navigation
      try {
        window.close()
      } catch (error) {
        // If window.close() fails, navigate back to meetings page
