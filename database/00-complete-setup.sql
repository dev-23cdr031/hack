...
CREATE TABLE IF NOT EXISTS hackathons (
  ...
  format VARCHAR(50) DEFAULT 'competitive', -- competitive, learning, community, corporate
  themes JSONB DEFAULT '[]',
  max_participants INTEGER,
  current_participants INTEGER DEFAULT 0,
  status VARCHAR(50) DEFAULT 'upcoming', -- upcoming, ongoing, past
  prize_amount INTEGER,
  skill_level VARCHAR(50) DEFAULT 'all-levels', -- beginner, intermediate, advanced, all-levels
